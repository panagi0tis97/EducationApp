...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { semester_id: @subject.semester_id, title: @subject.title } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { semester_id: @subject.semester_id, title: @subject.title } }
